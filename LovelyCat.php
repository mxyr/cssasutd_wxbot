...
class lovelyCat {
	...
	function sendTextMsg( $msg, $robwxid = null, $to_wxid = null ) {
	...
	function sendGroupAtMsg( $robwxid, $group_wxid, $at_wxid, $at_name, $msg ) {
		$data = array();
		$data[ 'type' ] = 102;
	...
	function sendImageMsg( $img_url, $robwxid = null, $to_wxid = null ) {
	...
	function sendVideoMsg( $mp4_path, $robwxid = null, $to_wxid = null ) {
	...
	function sendFileMsg( $file_path, $robwxid = null, $to_wxid = null ) {
	...
	function sendEmojiMsg( $path, $robwxid = null, $to_wxid = null ) {
	...
	function sendLinkMsg( $title, $text, $target_url, $pic_url, $robwxid = null, $to_wxid = null ) {
	...
	function sendMusicMsg( $name, $robwxid = null, $to_wxid = null ) {
		$data = array();
		$data[ 'type' ] = 108;
		$data[ 'msg' ] = $name;
		$data[ 'to_wxid' ] = $to_wxid ? : $this->from_wxid;
	...
	function getRobotName( $robwxid = null ) {
	...
	function getRobotHeadImageUrl( $robwxid = null ) {
	...
	function getLoggedAccount_list() {
	...
	function getFriendList( $robwxid = '', $is_refresh = 0 ) {
	...
	function getGroupMemberList( $robwxid, $group_wxid, $is_refresh = 0 ) {
	...
	function getGroupMember( $robwxid, $group_wxid, $member_wxid ) {
	...
	function acceptTransfer( $robwxid = null, $friend_wxid = null, $json_string = null ) {
	...
	function agreeGroupInvite( $robwxid = null, $json_string = null ) {
	...
	function agreeFriendVerify( $robwxid = null, $json_string = null ) {
	...
	function setFriendNote( $robwxid, $friend_wxid, $note ) {
	...
	function deleteFriend( $robwxid, $friend_wxid ) {
	...
	function removeGroupMember( $member_wxid, $group_wxid = null, $robwxid = null ) {
	...
	function setGroupName( $robwxid, $group_wxid, $group_name ) {
		$data = array();
		$data[ 'type' ] = 307;
		$data[ 'robot_wxid' ] = $robwxid; // 账户id
		$data[ 'group_wxid' ] = $group_wxid; // 群id
	...
	function setGroupNotice( $robwxid, $group_wxid, $notice ) {
	...
	function creatGroup( $robwxid, array $friends ) {
		$data = array();
		$data[ 'type' ] = 309;
		$data[ 'robot_wxid' ] = $robwxid; // 账户id
	...
	function quitGroup( $robwxid, $group_wxid ) {
		$data = array();
		$data[ 'type' ] = 310;
		$data[ 'robot_wxid' ] = $robwxid; // 账户id
		$data[ 'group_wxid' ] = $group_wxid; // 群id
	...
	function inviteInGroup( $robwxid, $group_wxid, $friend_wxid ) {
		$data = array();
		$data[ 'type' ] = 311;
		$data[ 'robot_wxid' ] = $robwxid;
	...
	function sendRequest( $params, $method = 'get', $timeout = 3 ) {
		$curl = curl_init();
